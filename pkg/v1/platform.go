...
func ParsePlatform(s string) (*Platform, error) { _ = "STUB: not implemented"; return nil, nil }
...
func (p Platform) Equals(o Platform) bool { _ = "STUB: not implemented"; return false }
...
func (p Platform) Satisfies(spec Platform) bool { _ = "STUB: not implemented"; return false }

func satisfies(want, have string) bool { _ = "STUB: not implemented"; return false }

func satisfiesList(want, have []string) bool { _ = "STUB: not implemented"; return false }
...
func stringSliceEqualIgnoreOrder(a, b []string) bool { _ = "STUB: not implemented"; return false }
