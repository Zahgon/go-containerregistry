...
func (vc *verifyReader) Read(b []byte) (int, error) { _ = "STUB: not implemented"; return 0, nil }
...
// pass all writes to the hasher.

// if we know the size, limit to that size.
...
func Descriptor(d v1.Descriptor) error { _ = "STUB: not implemented"; return nil }
