...
func NewCmdList() *cobra.Command { _ = "STUB: not implemented"; return nil }
...
func printImages(j bool) google.WalkFunc { _ = "STUB: not implemented"; return *new(google.WalkFunc) }
